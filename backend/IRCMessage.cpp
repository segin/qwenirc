...
QString IRCMessage::coloredText() const {
    ...
    case MessageType::NickChange:
        formatted +=
            timestampStr + QString("<span style=\"color: #FF8888;\">%1</span>").arg(formattedText().toHtmlEscaped());
        break;
    case MessageType::Join:
        formatted +=
            timestampStr + QString("<span style=\"color: #88FF88;\">%1</span>").arg(formattedText().toHtmlEscaped());
        break;
    case MessageType::Part:
        formatted +=
            timestampStr + QString("<span style=\"color: #FF8888;\">%1</span>").arg(formattedText().toHtmlEscaped());
    ...
    case MessageType::Mode:
        formatted +=
            timestampStr + QString("<span style=\"color: #8888FF;\">%1</span>").arg(formattedText().toHtmlEscaped());
        break;
    case MessageType::Topic:
        formatted +=
            timestampStr + QString("<span style=\"color: #8888FF;\">%1</span>").arg(formattedText().toHtmlEscaped());
    ...
    case MessageType::Error:
        formatted +=
            timestampStr + QString("<span style=\"color: #FF0000;\">%1</span>").arg(formattedText().toHtmlEscaped());
        break;
    case MessageType::Notice:
        formatted +=
            timestampStr + QString("<span style=\"color: #AAAAAA;\">%1</span>").arg(formattedText().toHtmlEscaped());
        break;
    case MessageType::System:
        formatted +=
            timestampStr + QString("<span style=\"color: #888888;\">%1</span>").arg(formattedText().toHtmlEscaped());
        break;
    }
